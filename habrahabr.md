...
Привелём пример наивной рекоммендательной системы с использованием корреляционной модели.

Имея матрицу user-item из оценок пользователей можно определить меру косинусной похожести товаров a и b как векторов в пространстве пользователей:
