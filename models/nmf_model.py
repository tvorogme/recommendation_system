...
def predict(input_articles, input_ids, tvrain_data, recommends_num):
    ...
    min_time = input_articles[0]['datetime'] - datetime.timedelta(hours=5)
    max_time = input_articles[-1]['datetime'] + datetime.timedelta(hours=5)
    mongo_query = {'datetime': {'$gt': min_time, '$lt': max_time}}
